...
HOOKS = (
    "Скільки б ви дали за такий килим {size}?",
    "У скільки б ви оцінили цей килим {size}?",
    "Скільки б ви заплатили за такий {size}?",
    "Скільки, по-вашому, коштує цей килим {size}?",
    "На яку ціну це схоже? Розмір {size}",
)

CTAS = (
    "Хто вгадав — пишіть 👇",
    "Хто був близько — пишіть 👇",
    "Хто назвав більше — пишіть 👇",
    "Ну як, вгадали? 👇",
    "Вгадали? Пишіть 👇",
)
