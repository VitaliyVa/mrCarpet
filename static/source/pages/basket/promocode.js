        ...
        promocodeBtn.addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    promocodeBtn.style.backgroundColor = '#28a745';
            ...
            .catch(error => {
                ...
                promocodeBtn.style.backgroundColor = '';
                promocodeBtn.style.color = '';
            });
        });
    }
    ...
    function updatePricesWithDiscount(data) {
        ...
        if (calculateBlock) {
            ...
            if (!discountBlock) {
                ...
                discountBlock.style.alignItems = 'center';
                discountBlock.style.padding = '15px 0';
                discountBlock.style.borderBottom = '1px solid #e9ecef';
                discountBlock.innerHTML = `
                    <p style="color: #6c757d; font-size: 14px;">Знижка</p>
                    <p style="font-weight: bold; font-size: 16px; color: #d4af37;">-${discount_percent}%</p>
                `;
