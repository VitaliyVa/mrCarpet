        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="Область"
                    ),
                ),
                (
                    "ref",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="Ref"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="Населений пункт"
                    ),
                ),
                (
                    "ref",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_desc",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="Скорочено"
                    ),
                ),
                (
                    "ref",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="Тип відділення"
                    ),
                ),
                (
                    "ref",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="Відділення"
                    ),
                ),
                (
                    "short_address",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="Короткий адрес"
                    ),
                ),
                (
                    "ref",
